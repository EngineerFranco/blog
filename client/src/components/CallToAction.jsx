...
const CallToAction = () => {
    return (
        <div className="flex flex-col sm:flex-row items-center justify-center px-2 sm:px-10 rounded-t-3xl mt-20 border border-teal-300/60">
            <div className="flex flex-col sm:flex-row items-center p-5 h-[15rem] ">
                <div className="flex flex-col text-center sm:text-left">
                    ...
                    <p className="font-medium flex items-center justify-center sm:justify-start text-nowrap">
                        ...
                        <a 
                            ...
                            className="ml-1"
                        >
                            <Button size="xs" gradientMonochrome="teal" className="text-nowrap" pill>here</Button>
                        </a>
                    </p>
                </div>
            </div>
            
            <div className="sm:p-5 -py-20 flex justify-center">
                <img 
